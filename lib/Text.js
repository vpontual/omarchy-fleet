...
// desktop bar, and none of them comes from somewhere this plugin controls. Each
// is stripped of anything that could break out of its row, and clamped to a
// length that cannot reflow the panel.
...
// A longer field than a nickname -- an error message naming several rejected
...
// A nickname is typed by the user rather than served by a node, and is still
// rendered, so it gets the same treatment as anything else displayed.
